...
public class AuthService {
    ...
    @NewSpan("auth.service.login")
    public JwtResponse login(@SpanTag("username") LoginRequest loginRequest) {
     ...
     */
    @NewSpan("auth.service.refreshToken")
    public JwtResponse refreshToken(@SpanTag("token.present") String oldToken) {
     ...
     */
    @NewSpan("auth.service.validateToken")
    public Map<String, Object> validateToken(@SpanTag("token.present") String token) {
