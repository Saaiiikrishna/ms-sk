...
public class AuthController {
    ...
    public ResponseEntity<?> login(
        ...
        try {
            ...
            logger.info("User {} login processed successfully.", loginRequest.getUsername());
    ...
    @NewSpan("auth.password-rotate")
    public ResponseEntity<?> rotatePassword(
            @Parameter(description = "UUID of the user whose password is to be rotated", required = true) @RequestParam @NotNull @SpanTag("user.id") UUID userId) {
